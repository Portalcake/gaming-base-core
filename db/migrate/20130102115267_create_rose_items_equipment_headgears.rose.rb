# This migration comes from rose (originally 20121213103429)
class CreateRoseItemsEquipmentHeadgears < ActiveRecord::Migration
  def change
    create_table :rose_items_equipment_headgears do |t|
