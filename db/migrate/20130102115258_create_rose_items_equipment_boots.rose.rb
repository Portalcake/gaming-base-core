# This migration comes from rose (originally 20121212215120)
class CreateRoseItemsEquipmentBoots < ActiveRecord::Migration
  def change
    create_table :rose_items_equipment_boots do |t|
